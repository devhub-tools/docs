export const metadata = {
  ...
  description:
    'Sign up for QueryDesk, then walk through connecting a database, running and approving queries, and checking the audit log.',
}

# Getting Started

This guide will get you up and running with QueryDesk. It covers your deployment options, then walks through the core features using the pre-configured **Devhub** database that ships with every new instance. {{ className: 'lead' }}
...
All cloud hosted installations are isolated and are single tenant. You can sign up for a free trial at [querydesk.com](https://querydesk.com).
...
![Databases page showing the Devhub entry with Connect button](/guides/getting-started/gsg-001.00.png)
...
![Query interface showing the left panel with table list, query pane, and results pane](/guides/getting-started/gsg-002.00.png)
...
<Tip>
Don't know SQL? Bring your own AI model and QueryDesk will make it schema-aware for your databases, so your team can describe what they want in plain language and get a working query back. See [Set up the AI assistant](#set-up-the-ai-assistant), coming next!
</Tip>
...
![Query interface with AI assistant highlighted in the left nav and Setup AI button](/guides/getting-started/gsg-003.00.png)

This opens Settings. Navigate to the **Integrations** tab and click **Settings** next to **AI** (3).

![Settings Integrations tab showing GitHub, Linear, Slack, AI, and Calendar Events entries with AI Settings button highlighted](/guides/getting-started/gsg-004.00.png)

Select a model from the **Model** dropdown (4), enter your **API key** for that model (5), and click **Save** (6).

![AI settings modal showing the Model dropdown, API KEY field, and Save button](/guides/getting-started/gsg-005.00.png)

Once saved, return to the **AI assistant** in the left navigation to open a conversation. Describe what you want to query in plain language. The assistant will generate SQL that you can run or edit before executing. Because your database schema is attached as context on every request, the suggestions are tailored to your specific databases without any training step on your part.

![AI assistant conversation showing query results and chat interface with Insert and Run options](/guides/getting-started/gsg-006.00.png)

![Left navigation panel with AI assistant highlighted](/guides/getting-started/gsg-007.00.png)
...
![Settings Users page showing the Settings gear, Users tab, and Invite User button](/guides/getting-started/gsg-008.00.png)

4. In the **Invite user** window, add the name and email address of the new user and click the **Invite** button.

![Invite user modal with Name and Email fields and Invite button](/guides/getting-started/gsg-009.00.png)
...
![Billing page showing the Seats to Add field and Add seats button](/guides/getting-started/gsg-010.00.png)

![Users page showing seats used, user list with Mark Smith and No license assigned status, and kebab menu](/guides/getting-started/gsg-011.00.png)
...
![User detail panel showing Assign license button, integration fields, permissions checkboxes, and Roles and Teams sections](/guides/getting-started/gsg-012.00.png)
...
![Database menu with Settings option highlighted](/guides/getting-started/gsg-013.00.png)

12. Once in the database Settings, scroll down to **RBAC** (**R**ole-**B**ased **A**ccess **C**ontrol) and click **Add user**.

![Database Settings page showing the RBAC section with Add user and Add role buttons](/guides/getting-started/gsg-014.00.png)

13. In the **Assign User** dropdown, select the user you want to add and click **Add user**.

![Assign User modal with Mark Smith selected and Add user button](/guides/getting-started/gsg-015.00.png)
...
![RBAC section showing Mark Smith with Permission dropdown open and Approver option highlighted](/guides/getting-started/gsg-016.00.png)
...
![Database Settings Credentials section showing devhub_readonly and devhub credentials](/guides/getting-started/gsg-017.00.png)
...
![Run query modal showing the devhub credential selected, 1 review required notice, and Request review button](/guides/getting-started/gsg-018.00.png)
...
![Pending queries view showing the submitted query with metadata, approval counter, and action buttons](/guides/getting-started/gsg-019.00.png)
...
![Pending queries view from the approver perspective showing the Approve button](/guides/getting-started/gsg-020.00.png)
...
![Pending queries view showing the approved query with Run Query button](/guides/getting-started/gsg-021.00.png)
...
![Audit log showing query entries with run timestamps, failure indicators, and error notifications](/guides/getting-started/gsg-022.00.png)
...
You can also feed this log into your existing security tooling.
...
- **Agent** - used to connect to databases inside a private network. Agents are configured in Settings. If you're unsure whether your database requires one, ask your IT, DevOps, or Engineering team.
...
If your database requires encryption, enable it with the toggle.
You can then paste the server CA certificate, client key, and client certificate (which may be optional depending on your database configuration).
